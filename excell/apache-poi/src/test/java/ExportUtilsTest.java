import poi.ExcelFormat;
import poi.ExcelHeaderInfo;
import poi.ExcelUtils;
import poi.TtlProductInfoPo;
...
public class ExportUtilsTest {
    ...
    // 获取表头信息
    private static final List<ExcelHeaderInfo> HEADER_INFO = Arrays.asList(
    ...
    public void export(HttpServletResponse response, String fileName) {
        ...
        ExcelUtils excelUtils = new ExcelUtils(productInfoPos, HEADER_INFO, getFormatInfo());
