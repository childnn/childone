...
public class MyGenerator {
    ...
    //     username: gy_mobanku
    //     password: dfhis2020
    public static final String URL = "jdbc:oracle:thin:@192.168.1.200:1521:xe/gy_mobanku";
    ...
    public static final String NAME = "gy_mobanku";
    public static final String PASS = "dfhis2020";
    public static final String DATABASE = "MB_CHANGYONGYU";

    public static final String TABLE = "cash_apply_log";
    public static final String CLASSCOMMENT = "提现进度日志";

    // 路径信息，分开路径方便聚合工程项目，微服务项目
    public static final String projectName = "df-mobanku";
    //是否是Swagger配置
