...
import tomcat4.org.apache.catalina.util.URLEncoder;
import tomcat4.org.apache.naming.JndiPermission;
import tomcat4.org.apache.naming.resources.Resource;
import tomcat4.org.apache.naming.resources.ResourceAttributes;
 ...
 * @version $Revision: 1.54 $ $Date: 2004/08/26 21:34:02 $
 */
public class WebappClassLoader
    ...
    public boolean modified() {
        ...
        if (getJarPath() != null) {
            ...
            try {
                NamingEnumeration<Binding> enm = resources.listBindings(getJarPath());
                int i = 0;
    ...
    protected URL getURL(File file)
        ...
        return new URL(urlEncoder.encode(realFile.toURI().toURL().toString()));
    }
