...
import tomcat4.org.apache.catalina.deploy.*;
import tomcat4.org.apache.naming.*;
import tomcat4.org.apache.naming.factory.ResourceLinkFactory;
 ...
 * @version $Revision: 1.23 $ $Date: 2004/09/05 18:43:08 $
 */
...
public class NamingContextListener
    ...
    public void containerEvent(ContainerEvent event) {
        ...
        if (type.equals("addEjb")) {
            ...
            if (ejbName != null) {
                tomcat4.org.apache.catalina.deploy.ContextEjb  ejb = namingResources.findEjb(ejbName);
                addEjb(ejb);
            }
     ...
     */
    public void addEjb(tomcat4.org.apache.catalina.deploy.ContextEjb  ejb) {
