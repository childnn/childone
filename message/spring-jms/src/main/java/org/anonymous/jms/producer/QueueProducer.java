...
public class QueueProducer {
    ...
    public void sendTextMessage(final String text) {
        /**
         * 封装对象的创建
         *  1. 创建连接工厂: {@link javax.jms.ConnectionFactory} {@link org.apache.activemq.ActiveMQConnectionFactory}
         *  2. 获取连接(开启连接): {@link javax.jms.Connection}
         *  3. 获取会话对象: {@link javax.jms.Session}
