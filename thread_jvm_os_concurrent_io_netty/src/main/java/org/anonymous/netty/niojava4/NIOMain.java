 ...
 * Operation-set 可选值:
 * @see java.nio.channels.SelectionKey#OP_ACCEPT  有新连接
 * @see java.nio.channels.SelectionKey#OP_CONNECT 连接完成
 * @see java.nio.channels.SelectionKey#OP_READ 准备好去读数据
 * @see java.nio.channels.SelectionKey#OP_WRITE 写入数据
 * ---
