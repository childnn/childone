...
public class HttpUtils {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String path = "/OAPI/getKeShi?pageIndex=1&pageSize=10";
        String method = "POST";
        ...
        // HttpResponse hr = doPost(host, path, method, new HashMap<String, String>() {{
        //     put("Authorization", "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzY29wZSI6WyI3OTA5ODE0Nzg5ODMxOTI1NzYiXSwiZXhwIjoxNjE5NTk1MTU1LCJqdGkiOiIyZDM5ZmZlMy1hN2JlLTQ0OWQtYTk3Yi0zNzNjNmUwNmQ2M2YiLCJjbGllbnRfaWQiOiJoYUt0VDhpMmF3RnZtRmhyIn0.ghq0EIYsyMpx-UpLbEB1aVKV8Kq78ywmHTA6dfozYf4");
        //
        ...
        //
        // // entity.writeTo(new ObjectOutputStream());
        // // System.out.println("entity = " + entity.getContent());
        // // ObjectInputStream is = new ObjectInputStream(entity.getContent());
